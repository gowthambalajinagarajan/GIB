...
public class ApprovePage extends BasePage{
	...
	private WebElement SaveSubmitMessage;
	...
	@FindBy(xpath="//*[@class='btn btn-primary waves-effect waves-button waves-float waves-effect waves-button waves-float']")
	private WebElement PendingForApproval;
	
	@FindBy(xpath="(//*[@class='btn btn-primary'])[3]")
	private WebElement ApproveButton;
	
	@FindBy(xpath="(//*[@class='btn btn-primary submit'])[1]")
	private WebElement ConfirmationYes;
	
	@FindBy(xpath="//*[@class='alert alert-success']")
	private WebElement ApproveSuccess;
	...
	public String getSaveSubmitMessage() {
		return SaveSubmitMessage.getText();
	}
	...
	public WebElement getPendingForApproval() {
	...
	public String getApproveSuccess() {
		return ApproveSuccess.getText();
	}
